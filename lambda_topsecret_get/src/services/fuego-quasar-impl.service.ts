    ...
    return new Promise((resolve, reject) => {
      ...
      this.adapter
        ...
        .then((_satellites) => {
          ...
          this.adapter.delKeys([CONSTANTS.KENOBI, CONSTANTS.SKYWALKER, CONSTANTS.SATO]);
        })
        .then((data) =>
          this.GetLocation(
        ...
        .then((message) => resolve(new Response(StatusCodes.OK, { position: position, message: message })))
        .catch((err) => {
